 ...
 */
@Entity
public class LoanAdjustmentApplication implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LoanAdjustmentApplication)) {
            return false;
        }
        LoanAdjustmentApplication other = (LoanAdjustmentApplication) object;
    ...
    public String toString() {
        return "entity.loan.LoanAdjustmentApplication[ id=" + id + " ]";
    }
