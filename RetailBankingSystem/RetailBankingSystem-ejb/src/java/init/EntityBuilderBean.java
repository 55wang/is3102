...
//        }
    ...
    private void initWealth(){
        ...
        financialInstrument1.setName(FinancialInstrumentClass.CORPORATE_BONDS);
        ...
        financialInstrument2.setName(FinancialInstrumentClass.DIVIDEND_GROWTH_STOCKS);
        ...
        financialInstrument3.setName(FinancialInstrumentClass.EMERGING_MARKET_BONDS);
        ...
        financialInstrument4.setName(FinancialInstrumentClass.EMERGING_MARKET_STOCKS);
        ...
        financialInstrument5.setName(FinancialInstrumentClass.FOREIGN_DEVELOPED_STOCKS);
        ...
        financialInstrument6.setName(FinancialInstrumentClass.MUNICIPAL_BONDS);
        ...
        financialInstrument7.setName(FinancialInstrumentClass.NATURAL_RESOURCES);
        ...
        financialInstrument8.setName(FinancialInstrumentClass.REAL_ESTATE);
        ...
        financialInstrument9.setName(FinancialInstrumentClass.TREASURY_INFLATION_PROTECTED_SECURITIES);
        ...
        financialInstrument10.setName(FinancialInstrumentClass.US_GOVERNMENT_BONDS);
        ...
        financialInstrument11.setName(FinancialInstrumentClass.US_STOCKS);
        ...
        List<FinancialInstrumentClass> preferedInstruments = new ArrayList<FinancialInstrumentClass>();
        preferedInstruments.add(FinancialInstrumentClass.CORPORATE_BONDS);
        preferedInstruments.add(FinancialInstrumentClass.EMERGING_MARKET_STOCKS);
        preferedInstruments.add(FinancialInstrumentClass.NATURAL_RESOURCES);
        preferedInstruments.add(FinancialInstrumentClass.US_GOVERNMENT_BONDS);
        investmentPlan.setPreferedFinancialInstrument(preferedInstruments);
        investmentPlan.setRemarks("test plan");
        investmentPlan.setStatus(InvestmentPlanStatus.PENDING);
