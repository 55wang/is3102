 ...
 * @author leiyang
 */
public class CustomerCaseNotFoundByTitleException extends Exception {

    /**
     * Creates a new instance of <code>CustomerNotExistException</code> without
     * detail message.
     */
    public CustomerCaseNotFoundByTitleException() {
    }
     ...
     */
    public CustomerCaseNotFoundByTitleException(String msg) {
        super(msg);
    }
}
