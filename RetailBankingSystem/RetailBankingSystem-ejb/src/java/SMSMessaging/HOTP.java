...
public class HOTP {
	...
	public static void main(String args[]) {
        // Seed, this is where your customer input the pin from the mobile phone number
        String seed = "SEED";
...
//        	System.out.println(System.currentTimeMillis());
            long unixTime = System.currentTimeMillis() / 1000L; // convert to second
//            System.out.println(unixTime);
            int unixMinute = (int) unixTime / 60; //convert to minute
//            System.out.println(unixMinute);

            //past 5 min to future 10 min duration of token would be generated. 
            //store in hashmap or arraylist, if customer enter anyone of the generated token, it would be accepted.
            for (int minute = unixMinute - 5; minute <= unixMinute + 10; minute++) {
                    String strGeneratedToken = HOTP.generateOTP(code, minute, 6, false, 0);
                        System.out.println(minute + " -> " + strGeneratedToken );
