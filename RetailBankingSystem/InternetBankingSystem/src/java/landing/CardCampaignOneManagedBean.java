 ...
 * @author wang
 */
@Named(value = "cardCampaignOneManagedBean")
@ViewScoped
public class CardCampaignOneManagedBean extends MarketingCampaignAbstractBean implements Serializable {
    ...
    public CardCampaignOneManagedBean() {
    }
