 ...
 * @author leiyang
 */
@Named(value = "loanAccountHistoryManagedBean")
@ViewScoped
public class LoanAccountHistoryManagedBean implements Serializable {
    ...
    /**
     * Creates a new instance of LoanAccountHistoryManagedBean
     */
    public LoanAccountHistoryManagedBean() {
    }
