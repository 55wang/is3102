...
public class Analyze {
     ...
     */
    private static final String APPLICATION_NAME = "RetailBankingSystem";
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        System.out.println("Analyze: Testing NLP");
        Analyze analyzeApp = new Analyze(Analyze.getLanguageService());
        Sentiment sentiment
                = analyzeApp.analyzeSentiment("banking industry is dying!");

        //positive or negative sentence
        System.out.println("Sentiment Score range(-1 to 1): "+sentiment.getPolarity());
        //emotion strength score
        System.out.println("Emotion Strength Score range(0 to +infinitive): "+sentiment.getMagnitude());
    }
    ...
    /**
     * Connects to the Natural Language API using Application Default
     * Credentials.
     */
    public static CloudNaturalLanguageAPI getLanguageService()
            throws IOException, GeneralSecurityException {

        GoogleCredential credential = GoogleCredential.fromStream(Analyze.class.getResourceAsStream("googlecredential.json")).createScoped(CloudNaturalLanguageAPIScopes.all());
