...
public class StaffCustomerInformationCounterManagedBean implements Serializable {
    ...
    public void setCustomers() {
        ...
        a.setActivityLog("Counter user enter create_customer_information.xhtml");
        a.setFunctionName("StaffCustomerInformationCounterManagedBean @PostConstruct setCustomers()");
    ...
    public void goToEditPage(Customer customer) {
        ...
        RedirectUtils.redirect(ConstantUtils.COUNTER_CMS_STAFF_EDIT_CUSTOMER);
    }
