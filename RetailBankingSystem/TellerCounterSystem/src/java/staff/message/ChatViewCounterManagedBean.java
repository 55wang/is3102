...
@Named(value = "chatViewCounterManagedBean")
@ViewScoped
public class ChatViewCounterManagedBean implements Serializable {
    ...
    public void init() {
        ...
        a.setActivityLog("Counter user enter ChatViewManagedBean");
