 ...
 * @author leiyang
 */
@Named(value = "payOtherBillCounterManagedBean")
@ViewScoped
public class PayOtherBillCounterManagedBean implements Serializable {
     ...
     */
    public PayOtherBillCounterManagedBean() {
    }
    ...
    public void retrieveMainAccount() {
        ...
        try {
            ...
            billOrgsOptions = billBean.getActiveListOrganization();
            addedBillOrgs = billBean.getBillingOrgMainAccountId(mainAccount.getId());
    ...
    public void transfer() {
        ...
        try {
            ...
            System.out.println("DepositAccountNotFoundException PayOtherBillCounterManagedBean transfer()");
            MessageUtils.displayError(ConstantUtils.TRANSFER_FAILED);
        }
    ...
    private void transferClearing() {
        try {
            ...
            System.out.println("DepositAccountNotFoundException | UpdateDepositAccountException PayOtherBillCounterManagedBean transfer()");
            MessageUtils.displayError(ConstantUtils.TRANSFER_FAILED);
        }
    }
