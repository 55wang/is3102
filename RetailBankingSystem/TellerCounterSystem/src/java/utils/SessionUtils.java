...
public class SessionUtils {
    ...
    public static void setTellerCounter(TellerCounter tc) {
        HttpSession session = getSession();
        session.setAttribute("TellerCounter", tc);
    }
    ...
    public static TellerCounter getTellerCounter() {
        HttpSession session = getSession();
        return (TellerCounter)session.getAttribute("TellerCounter");
    }
